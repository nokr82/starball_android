...
public class SwipeStack extends ViewGroup {
    ...
    public SwipeHelper getmSwipeHelper() {
        return mSwipeHelper;
    }
    ...
    private void readAttributes(AttributeSet attributeSet) {
        ...
        try {
            mAllowedSwipeDirections = attrs.getInt(R.styleable.SwipeStack_allowed_swipe_directions, SWIPE_DIRECTION_ONLY_LEFT);
    ...
    private void reorderItems() {
        ...
        System.out.println("reorderItems reorderItems");
    ...
    public void onViewSwipedToBottom() {
        if (mListener != null) mListener.onViewSwipedToBottom(getCurrentPosition());
        removeTopView();
    }
